...
\\\\
\todo[inline]{DONE-start (mathias In this paragraph it is unclear that we actually did this, rewrite such that it is clear)}
...
\end{figure}
\todo{DONE-start(holm): Write about the limitation of this settings, we have preset amount of settings. Also mention that we considered two sliders.}
