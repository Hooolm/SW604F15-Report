...
Note that this new type of setting (the slider) decrease the amount of possible ways the applications can be displayed. With the updated settings, since there are only a fixed amount (six) of settings for the slider. This functionality is limited in comparison to previous slider, that scaled the icons and then calculated the amount of icons here after. 