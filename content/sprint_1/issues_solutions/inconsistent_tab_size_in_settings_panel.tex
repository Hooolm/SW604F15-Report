...
In the settings part of the \launcher application (\androidinline{SettingsActivity}), the user is presented with different tabs containing settings for \emph{some} of the different parts of the overall \giraf suite. Each of these tabs contain a headline and a small description of the tab. However, when a setting pane is pressed, the description disappears. This causes the size of the tab to change, which can be confusing for the users. An example of the problem can be seen in \figref{fig:inconsistent_tab_size_in_settings_panel_example}.\\
