...
\\\\
The \giraf software suite contains a lot of different applications. A list of all applications along with a short description of these can be found in \appref{cha:project_overview}.
