...
We provide a dialog called \androidinline{GirafCustomButtonsDialog} for simple dialog with more than two buttons.\\

For more specialized dialogs, we provide a more customizable dialog called \androidinline{GirafInflatableDialog}, which inflates a given layout resource, parsed as a parameter, for the dialog.
