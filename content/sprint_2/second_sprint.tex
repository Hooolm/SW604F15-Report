...
\\\\
\todo{DONE-start (holm): Skriv hvad der står i kapitlet}This chapter covers a description of an issue regarding changing the development environment. This chapter also contains a description of some new shared GUI components alongside with a redesign of the assigned application, the \ct. \todo{DONE-end (holm)}
