...
\\\\
It was decided that the users should be put in a \androidinline{GridView} like seen in \todo{Insert figure of the dialog and ref to it}. The profiles in the grid should be clickable and allow the user to select the wanted profile easily. When a profile is selected its marked with a yellowish color as indicator.
\\\\
